...
export const projects: Project[] = [
  {
    ...
    reraNumber: 'Demo Concept (Portfolio Showcase)',
    configurations: ['3 BHK Sanctuary', '4 BHK Grand Estate'],
    areaRange: '2,450 – 3,850',
    areaUnit: 'sqft',
    priceRange: 'Illustrative Concept Range',
    possession: '2028 Possession (Concept)',
    totalFloors: 6,
    totalUnits: 36,
    highlights: [
      {
  ...
  },
  {
    ...
    areaUnit: 'sqft',
    priceRange: 'Illustrative Concept Range',
    possession: 'Completed 2024 (Concept)',
    totalFloors: 14,
    totalUnits: 28,
    highlights: [
  ...
  },
  {
    ...
    areaUnit: 'sqft',
    priceRange: 'Illustrative Concept Range',
    possession: '2027 Possession (Concept)',
    totalFloors: 18,
    totalUnits: 48,
    highlights: [
